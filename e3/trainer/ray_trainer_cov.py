...
def compute_advantage(
    ...
    if adv_estimator == AdvantageEstimator.GAE:
        ...
        advantages, returns = core_algos.compute_covvar_outcome_advantage(
            token_level_rewards=data.batch["token_level_rewards"],
    ...
    def fit(self):
        ...
        for epoch in range(self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:
                ...
                print("Len rollout n prompt",len(rollout_n_per_prompt))
                print("Len rollout n prompt",self.rollout_n, self.rollout_n * len(batch_dict["rank"]))
